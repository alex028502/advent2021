...
(check-equal?
 (list->set (consolidate-on-dimension 0 (smash '((3 5) (2 6)) '((1 9) (1 9)))))
 (list->set '(((1 9) (1 1)) ((1 2) (2 6)) ((6 9) (2 6)) ((1 9) (7 9)))))

(check-equal?
 (list->set (consolidate-on-dimension 1 (smash '((3 5) (2 6)) '((1 9) (1 9)))))
 (list->set '(((1 2) (1 9)) ((3 5) (1 1)) ((3 5) (7 9)) ((6 9) (1 9)))))
...
(check-equal? (pair-up '(1 2 3 "A" "C" 4)) '((1 2) (3 "A") ("C" 4)))

(check-equal? (fuse-on-dimension
               0
               '(((1 2) (5 7)) ((4 11) (5 7)) ((12 14) (5 7)) ((18 18) (5 7))))
              '(((1 2) (5 7)) ((4 14) (5 7)) ((18 18) (5 7))))

(check-equal? (sort-on-dimension
               0
               '(((4 11) (5 7)) ((12 14) (5 7)) ((1 2) (5 7)) ((18 18) (5 7))))
              '(((1 2) (5 7)) ((4 11) (5 7)) ((12 14) (5 7)) ((18 18) (5 7))))
